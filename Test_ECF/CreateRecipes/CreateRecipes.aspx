    ...
    <div class="div_main_content">
        ...
        <div class="nav_tab">
            <div class="div_content_title_recipe">
                ...
                <asp:TextBox ID="TxtBoxTitle" CssClass="TxtBoxTitle" runat="server" OnTextChanged="TxtBoxTitle_TextChanged"></asp:TextBox>
            </div>
            <div class="div_content_title_recipe">
            ...
            <div class="div_content_ingredients">
                <asp:Label ID="LblIngredients" CssClass="LblIngredients" runat="server" Text="Nombre d'ingrédient dans votre recette :"></asp:Label>
                <asp:TextBox ID="TxtBoxIngredient" CssClass="TxtBoxIngredient" runat="server" TextMode="Number"></asp:TextBox>
            </div>
