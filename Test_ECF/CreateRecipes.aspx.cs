...
namespace Test_ECF
{
    public partial class CreateRecipes : System.Web.UI.Page
    {
        ...
        protected void BtnCreateRecipe_Click(object sender, EventArgs e)
        {
            ...
            string img_recipe = @"<img class=""img_cuisson"" src=" + urlIMG + "></img>";
            string finIMG = "</div>";
            ...
            string allergenesRecipes = @"<br /><div><div class=""info_allergenes""><h3> Allergènes :</h3><p>" + allergene + "</p></div><br /></div>";
            string endUpPage = @" </section></article></div>";
            string wrapper = @"<section class=""info-wrapper""><br /><div class=""ingredient_recipe"">";
            string ingredientPage = @"<h3>Ingrédients</h3><br /><br /><li>" + ingredient + "</li></div><br/>";
            string etapePage = @"<div class=""info_container""><h3>Étapes</h3><br /><br /><li>" + etape + "</li>";
